...
bestao5label.grid(row=0, column=0, padx=5, pady=5)

besttime = tk.StringVar(master=root,value="Best Time")
besttimelabel = tk.Label(root, textvariable=besttime)
besttimelabel.grid(row=0, column=1, padx=5, pady=5)

bestao12 = tk.StringVar(master=root,value="Best Ao12")
bestao12label = tk.Label(root, textvariable=bestao12)
bestao12label.grid(row=0, column=2, padx=5, pady=5)


bestao5num = tk.StringVar(master=root,value="-.---")
bestao5numlabel = tk.Label(root, textvariable=bestao5num)
bestao5numlabel.grid(row=1, column=0, padx=5, pady=5)

besttimenum = tk.StringVar(master=root,value="-.---")
bestbesttimenumlabel = tk.Label(root, textvariable=besttimenum)
besttimenumlabel.grid(row=1, column=1, padx=5, pady=5)

bestao12num = tk.StringVar(master=root,value="-.---")
bestbestao12numlabel = tk.Label(root, textvariable=bestao12num)
bestao12numlabel.grid(row=1, column=2, padx=5, pady=5)
